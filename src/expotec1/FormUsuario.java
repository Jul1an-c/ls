...
public class FormUsuario extends JFrame {
    ...
    public void Etiquetas() {
        ...
        JLabel img = new JLabel(new ImageIcon("img/usuario.png"));
    ...
    public void Botones() {
   JButton reposiciondetarjeta = new JButton("<html><center>Reposicion de tarjeta<br></center                                                                                                       ></html>");
        ...
        JButton Datos = new JButton("<html><center>Datos<br></center                                                                                                       ></html>");
